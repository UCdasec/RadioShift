function dlhdlhelperModClassPlotScores(score,labels, title_str)
...
if nargin < 3  % If b is not provided, set default
        title_str = "Classification Scores";
end
co = [0.08 0.9 0.49;
  0.52 0.95 0.70;
  0.36 0.53 0.96;
...
xlabel('Frame Number'); ylabel('Score'); title(title_str)
end