classdef dlhdlhelperModClassTestChannel < matlab.System
...
%   Copyright 2018 The MathWorks, Inc.
  ...
  properties (Nontunable)
    ...
    HardSetOffsetPPM = 0
    %   Specify how the clock offset and sampling drift should be
    %   determined. If HardSetOffsetPPM is 0, then we randomly determine
  ...
  methods
    function obj = dlhdlhelperModClassTestChannel(varargin)
